...
VERSION = 55.2
UNICODE_VERSION = 7.0
SO_TARGET_VERSION = 55.2
SO_TARGET_VERSION_MAJOR = 55
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt55
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt55 
ICUDATA_CHAR = l
...
ICULEHB_CFLAGS=-I/usr/local/include -I/usr/include/icu-le-hb -I/usr/include/harfbuzz -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include
